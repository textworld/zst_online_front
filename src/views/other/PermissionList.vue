  ...
  <a-card :bordered="false">
    ...
    <s-table :columns="columns" :data="loadData">
      ...
      <span slot="actions" slot-scope="text, record">
        <a-tag v-for="(action, index) in record.actions" :key="index">{{ action.description }}</a-tag>
      </span>
...
<script>
  ...
  import { getPermissionList } from '@/api/manage'
  ...
  export default {
    ...
    data () {
      return {
        ...
        loadData: parameter => {
          return getPermissionList(Object.assign(parameter, this.queryParam)).then(res => {
